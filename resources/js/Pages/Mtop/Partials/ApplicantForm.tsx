...
export default function ApplicantForm({
    ...
    const togglePaidBy = () => {
        if (!data.show_paid_by) {
            // Turning ON: Default to the applicant's current name
            setData({
                ...data,
                show_paid_by: true,
            ...
            // Turning OFF: Clear the paid_by fields
            setData({
                ...data,
                show_paid_by: false,
                paid_by_last_name: "",
