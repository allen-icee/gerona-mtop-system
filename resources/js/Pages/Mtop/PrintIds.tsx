                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-500 mt-0.5">
                            Use A4 Sheet or export single IDs
                        </p>
                    </div>
                </div>
                <div className="flex items-center gap-3">
                    <button
                        ...
                        className="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-2 rounded-lg font-bold text-sm shadow-md transition-colors cursor-pointer"
                    >
                        ...
                        >
                            ...
                            <div className="no-print w-[4in] flex justify-end gap-2 mb-2">
                                <button
                                    ...
                                    className="flex items-center gap-1.5 bg-emerald-100 hover:bg-emerald-200 text-emerald-700 px-3 py-1.5 rounded-md text-[10px] font-extrabold uppercase tracking-wider transition-colors shadow-sm cursor-pointer"
                                >
                                    <Icon
                                ...
                                <button
                                    onClick={() =>
                                        handlePrintSingle(`id-card-${app.id}`)
                                    }
                                    className="flex items-center gap-1.5 bg-blue-100 hover:bg-blue-200 text-blue-700 px-3 py-1.5 rounded-md text-[10px] font-extrabold uppercase tracking-wider transition-colors shadow-sm cursor-pointer"
                                >
                                    <Icon
                            ...
                            <div
                                id={`id-card-${app.id}`}
                                className="w-[4in] h-132 border-2 border-black relative overflow-hidden font-sans flex flex-col px-[8mm] py-[2mm] shadow-sm print:shadow-none shrink-0 bg-white"
                                style={{
                            ...
                            >
                                <div className="relative z-10 grid grid-cols-[60px_1fr] items-center mb-4">
                                    ...
                                    <div className="text-center leading-tight mt-0.75 mb-0 ml-0">
                                        ...
                                        <h1 className="text-[11pt] font-['LEMONMILK'] font-bold uppercase tracking-wider [-webkit-text-stroke:1.5px_white] [paint-order:stroke_fill]">
