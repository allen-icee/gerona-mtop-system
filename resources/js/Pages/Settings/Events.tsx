                                    ...
                                    <div className="flex justify-between items-start border-b border-gray-100 pb-3">
                                        ...
                                        <div className="flex flex-col items-end gap-1">
                                            <button
                                                ...
                                                className={`relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 ${evt.is_active ? "bg-blue-500" : "bg-gray-300"}`}
                                            >
                                                <span
